...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsCSV = array(   
		"`NewsPapers`.`id`" => "id",
		"`NewsPapers`.`Language`" => "Tên Trang Bị",
		"`NewsPapers`.`Name`" => "Nhà Cung Cấp",
		"if(`NewsPapers`.`Date_Of_Receipt`,date_format(`NewsPapers`.`Date_Of_Receipt`,'%d/%m/%Y'),'')" => "Ngày Lắp Đặt",
		"if(`NewsPapers`.`Date_Published`,date_format(`NewsPapers`.`Date_Published`,'%d/%m/%Y'),'')" => "Thời Gian Bảo Hành",
		"`NewsPapers`.`Pages`" => "Số Lượng",
		"`NewsPapers`.`Price`" => "Giá Thành",
		"`NewsPapers`.`Type`" => "Tổng Tiền",
		"`NewsPapers`.`Publisher`" => "Ghi Chú"
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`NewsPapers`.`Language`" => "Tên Trang Bị",
		"`NewsPapers`.`Name`" => "Nhà Cung Cấp",
		"`NewsPapers`.`Date_Of_Receipt`" => "Ngày Lắp Đặt",
		"`NewsPapers`.`Date_Published`" => "Thời Gian Bảo Hành",
		"`NewsPapers`.`Pages`" => "Số Lượng",
		"`NewsPapers`.`Price`" => "Gía Thành",
		"`NewsPapers`.`Type`" => "Tổng Tiền",
		"`NewsPapers`.`Publisher`" => "Ghi Chú"
	);
	...
	$x->ColCaption = array("Tên Trang Bị", "Nhà Cung Cấp", "Ngày Lắp Đặt", "Thời Gian Bảo Hành", "Số Lượng", "Giá Thành", "Tổng Tiền", "Ghi Chú");
