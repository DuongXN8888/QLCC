...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsCSV = array(   
		"`Users`.`id`" => "STT",
		"`Users`.`Membership_Number`" => "Mã Căn Hộ",
		"`Users`.`Name`" => "Căn Hộ",
		"`Users`.`Contact`" => "Chủ Hộ",
		"`Users`.`ID_Number`" => "Số Điện Thoại"
	);
